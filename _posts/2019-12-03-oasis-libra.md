...
テーマなしひとりアドベントカレンダー、今日はKindle OasisとKobo Libra H2O比較レビューのドラフトを書く。ステップを踏んで写真を撮って比較して、とやっているととても1日では書き終わらない。ドラフトとして、文章だけをまずは書く。近いうちに、必要な写真を加えた上でちゃんとレビューにしようと思う。
